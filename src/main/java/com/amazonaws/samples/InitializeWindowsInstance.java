...
public class InitializeWindowsInstance {
	...
	public static void main(String[] args) {
		...
		runInstancesRequest.withImageId("ami-04f33832b669e4355").withInstanceType(InstanceType.T2Micro).withMinCount(1)
